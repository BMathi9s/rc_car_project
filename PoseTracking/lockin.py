...
class Marshmellow_Cannon:
    def __init__(self, base_channel, cannon_channel, base_angle=180, cannon_angle=90, deadzone=5, max_delta=10, speed=1):
...
# Variable to track whether to update the position or hold
lock_on = False
...
while cap.isOpened():
    ...
    if time_elapsed > 1./fps_limit:
        ...
        if results.pose_landmarks and not lock_on:
        ...
        if key == ord('q'):
            ...
            lock_on = not lock_on  # Toggle lock on/off
